...
ARDUINO_recv=27  #zise
ARDUINO_send=22

# %%
class Arduino_communicate():
    def __init__(self,gpio):
        self.recvPort=ARDUINO_recv
        self.sendPort=ARDUINO_send
        self.gpio=gpio
    ...
    def write(self,data=b'0'):
        ...
        self.gpio.write(self.sendPort,1)
        time.sleep(1)
        print(data)
        # self.ser.write(data)
        self.gpio.write(self.sendPort,0)
    ...
    def read(self):
        ...
        #     pass
        # return strin
        if (self.gpio.read(self.recvPort)):
            return "2002"
        else :
            return "0"
    def close(self):
...
gpio.set_mode(ARDUINO_recv,pigpio.INPUT)
gpio.set_mode(ARDUINO_send,pigpio.OUTPUT)

# client=Client(rpi_B_info)

arduino=Arduino_communicate(gpio)
